...
$ sudo pacman -S noto-fonts-{cjk,emoji,extra} arc-{gtk,icon}-theme nwg-{look,bar,panel,clipman} pipewire-pulse swaybg qt6ct
...
$ yay -S ttf-hackgen xremap-hypr-bin hyprpolkitagent-git hyprshot-git
```
