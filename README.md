...
$ yay -S hyprland-git
$ sudo pacman -S hyprpaper archlinux-wallpaper xdg-desktop-portal-hyprland pipewire pipewire-pulse pavucontrol lxsession-gtk3 mako libnotify waybar wofi pcmanfm-gtk3 gvfs foot noto-fonts-{cjk,emoji,extra} ly exa bat
```
