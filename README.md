...
```
$ yay -S ttf-hackgen
$ yay -S swayfx swaybg archlinux-wallpaper xdg-desktop-portal-wlr pipewire pipewire-pulse pavucontrol lxsession-gtk3 mako waybar wofi pcmanfm-gtk3 gvfs foot noto-fonts-{cjk,emoji,extra} ly lsd
```
