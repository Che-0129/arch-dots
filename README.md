...
$ sudo pacman -S zip unzip aria2 npm eza less brightnessctl archlinux-wallpaper udisks2 ly gvfs imv
$ yay -S ttf-hackgen xremap-wlroots-bin clipse-bin hyprshot
```
