...
## 色々インストール
```
$ sudo pacman -S hypr{land,lock,idle} xdg-desktop-portal-hyprland mako wofi foot pcmanfm-gtk3 xarchiver
$ sudo pacman -S noto-fonts-{cjk,emoji,extra} arc-{gtk,icon}-theme nwg-{look,bar,panel,clipman} pipewire-pulse swaybg
$ sudo pacman -S zip unzip aria2 android-tools npm eza less archlinux-wallpaper udisks2 ly gvfs imv btop wqy-zenhei gopsuinfo libnotify
$ yay -S ttf-hackgen xremap-hypr-bin hyprpolkitagent-git
```
