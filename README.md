...
## 色々インストール(Hyprland)
```
$ sudo pacman -S archlinux-wallpaper btop eza foot gopsuinfo gvfs hypr{idle,land,lock,polkitagent,shot} imv kvantum less mako noto-fonts-{cjk,emoji,extra} npm nwg-{clipman,drawer,hello,look,panel} pcmanfm-gtk3 pipewire-pulse qt6ct udisks2 unzip uwsm wqy-zenhei xarchiver xdg-desktop-portal-hyprland zip
